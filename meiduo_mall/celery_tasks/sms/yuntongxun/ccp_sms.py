...
_accountSid = '8aaf070870e20ea10170edca2ba00855'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '33fc9dd942e149b08d52faae4a0ab4cb'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8aaf070870e20ea10170edca2c09085b'
...
if __name__ == '__main__':
    # 注意： 测试的短信模板编号为1
    # sendTemplateSMS('13683084940', ['123456', 5], 1)
    # 单例类发送短信验证码
    print(CCP().send_template_sms('13683084940', ['123456', 5], 1))
